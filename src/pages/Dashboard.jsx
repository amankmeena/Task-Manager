...
function Dashboard() {
    ...
    const upcomingTasks = tasks.filter(task => !task.completed && task.dueDate >= currentDate);
    const overdueTasks = tasks.filter(task => !task.completed && task.dueDate < currentDate);
